  ...
  resources: {
    en: {
      ...
      user: {
        ...
        'seeYourProfileInformation': 'See your profile information',
        'myProducts': 'My products',
        'yourCurrentlyHave': 'You currently have: ',
        'productsOnOffer': 'products on offer',
        'addNewProduct': 'Add a new product',
        'seeAllMyProducts': 'See all my products',
        'myOrders': 'My orders',
        'orders': 'orders',
        'viewAllOrders': 'View all orders',
        'viewAllReceivedOrders': 'View all received orders',
        'Back': 'Back',
        'Next': 'Next',
        'Submit': 'Submit',
    ...
    es: {
      ...
      user: {
        ...
        'newOrdersReceived': 'Nuevos pedidos recibidos:',
        'myProfile': 'Mi perfil',
        'seeYourProfileInformation': 'Ver su información de perfil',
        'myProducts': 'Mis productos',
        'yourCurrentlyHave': 'Ahora tienes: ',
        'productsOnOffer': 'productos en oferta',
        'addNewProduct': 'Añadir un nuevo producto',
        'seeAllMyProducts': 'Ver todos mis productos',
        'myOrders': 'Mis ordenes',
        'orders': 'ordenes',
        'viewAllOrders': 'Ver todos los ordenes',
        'viewAllReceivedOrders': 'Ver todas las órdenes recibidas',
        'Back': 'Atrás',
        'Next': 'Adelante',
        'Submit': 'Envior',
        'PleaseUploadPhoto': 'Por favor cargue una foto',
